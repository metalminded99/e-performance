...
insert  into `tbl_appraisal`(`appraisal_id`,`job_id`,`appraisal_title`,`appraisal_desc`,`date_created`) values (1,7,'asd','asd','2013-11-26 02:16:09'),(2,7,'asdasdasd','asdasdasdasd','2013-11-26 02:17:06'),(3,7,'asdad','asdasd','2013-11-28 09:35:34');
...
insert  into `tbl_appraisal_assignment`(`assign_id`,`app_id`,`user_id`,`status`,`date_assigned`) values (1,2,6,'Completed','2013-11-26 02:25:16');
...
insert  into `tbl_appraisal_mngr_assignment`(`assign_id`,`manager_id`,`app_id`,`status`) values (1,2,2,'Pending');
...
insert  into `tbl_appraisal_peer_assignment`(`assign_id`,`peer_id`,`app_id`,`status`) values (1,7,2,'Pending');
...
/*Data for the table `tbl_appraisal_percentage` */

insert  into `tbl_appraisal_percentage`(`appraisal_id`,`main_cat_id`,`percentage`) values (1,1,75),(1,2,10),(1,3,5),(1,4,5),(2,1,75),(2,2,15),(2,3,5),(2,4,5),(3,1,40),(3,2,20),(3,3,30),(3,4,10);
...
insert  into `tbl_appraisal_questionaire`(`question_id`,`appraisal_id`,`question`,`category`,`sub_category`) values (1,1,'asdasd',1,1),(2,1,'oiahnsdansdasd',2,2),(3,1,'asdasd',3,3),(4,1,'asdasdasdasd',4,4),(5,2,'asdasdad',1,5),(6,2,'dasdasdasd',2,6),(7,2,'sdasdasdasd',3,7),(8,2,'sdasdasdasd',4,8),(9,3,'asd',1,9),(10,3,'asdasdasd',1,9),(11,3,'asdasdasdasd',1,10),(12,3,'asdasd',1,10),(13,3,'sadasd',2,11),(14,3,'dasdasdasd',3,12),(15,3,'fasdasdasdasd',4,13);
...
insert  into `tbl_appraisal_result`(`user_id`,`appraisal_id`,`question_id`,`self_score`,`peer_id`,`peer_score`,`manager_id`,`manager_score`,`date_submit`) values (6,2,5,4,NULL,NULL,NULL,NULL,'2013-11-26 02:35:26'),(6,2,6,3,NULL,NULL,NULL,NULL,'2013-11-26 02:35:26'),(6,2,7,2,NULL,NULL,NULL,NULL,'2013-11-26 02:35:26'),(6,2,8,3,NULL,NULL,NULL,NULL,'2013-11-26 02:35:26');
...
insert  into `tbl_appraisal_sub_categories`(`sub_category_id`,`main_cat_id`,`appraisal_id`,`sub_category_name`) values (1,1,1,'asdasd'),(2,2,1,'asdkajsdoiao'),(3,3,1,'asdasdasd'),(4,4,1,'asdasd'),(5,1,2,'asdasd'),(6,2,2,'asdas'),(7,3,2,'asda'),(8,4,2,'asda'),(9,1,3,'asd'),(10,1,3,'asdas'),(11,2,3,'asd'),(12,3,3,'asdas'),(13,4,3,'asd');
...
/*Data for the table `tbl_appraisal_training` */
...
/*Data for the table `tbl_appraisal_training_assignment` */
...
/*Data for the table `tbl_appraisal_training_main_categories` */
...
/*Data for the table `tbl_appraisal_training_questionaire` */
...
/*Data for the table `tbl_appraisal_training_result` */
...
/*Data for the table `tbl_appraisal_training_sub_categories` */
...
insert  into `tbl_emp_development`(`user_id`,`training_id`,`date_start`,`date_end`,`comment`,`status`,`date_assigned`) values (6,5,'2013-11-04','2013-11-12','','On-going','2013-11-05 16:40:41'),(6,6,'2013-11-21','2013-11-30','','Completed','2013-11-21 06:30:38'),(6,7,'2013-12-02','2013-12-06','','Pending','2013-11-28 05:18:40');
...
insert  into `tbl_emp_goals`(`goal_id`,`user_id`,`goal_title`,`goal_desc`,`due_date`,`days_to_remind`,`status`,`percentage`,`deliverables`,`success_measure`,`self_score`,`peer_score`,`sup_score`,`date_created`,`approved`,`sup_comment`,`date_approved`,`dept_goal_id`) values (12,7,'test','test','2013-06-30',3,'Pending',0,'test','test',NULL,NULL,NULL,'2013-11-12 21:48:41',1,NULL,'2013-06-26 10:46:16',3),(14,6,'my goal','my goal','2013-09-01',3,'Completed',100,'my goal','my goal',NULL,NULL,NULL,'2013-11-12 21:48:51',1,NULL,'2013-08-28 11:53:59',3),(15,6,'asdasd','asd','2013-11-30',2,'Rejected',0,'asdas','dasd',NULL,NULL,NULL,'2013-11-12 21:49:21',0,NULL,'2013-11-03 05:42:01',4),(16,6,'improve self performance','njusbujdb','2014-11-01',50,'Pending',0,'self performance appraisal report','performance',NULL,NULL,NULL,'2013-11-27 14:45:42',1,NULL,'2013-11-27 02:45:42',6),(17,8,'Cleanliness','clean as you go','2013-11-07',1,'Pending',0,'report','attainable',NULL,NULL,NULL,'2013-11-05 19:02:49',0,NULL,NULL,2);
...
insert  into `tbl_emp_journals`(`journal_id`,`user_id`,`journal_title`,`journal_desc`,`date_created`,`modified_date`) values (1,6,'test','test','2013-11-28 05:43:04',NULL);
...
insert  into `tbl_emp_process`(`user_id`,`process_id`,`date_start`,`date_accomplished`,`date_assigned`,`status`) values (2,5,'2013-11-20 02:10:50',NULL,'2013-11-20 13:37:40','On-going'),(6,5,NULL,NULL,'2013-11-20 13:37:40','Pending'),(7,5,NULL,NULL,'2013-11-20 13:37:41','Pending'),(8,5,NULL,NULL,'2013-11-20 13:37:41','Pending'),(9,5,NULL,NULL,'2013-11-20 13:37:41','Pending'),(10,5,NULL,NULL,'2013-11-20 13:37:41','Pending'),(11,5,NULL,NULL,'2013-11-20 13:37:41','Pending'),(12,5,NULL,NULL,'2013-11-20 13:37:41','Pending'),(13,5,NULL,NULL,'2013-11-20 13:37:41','Pending'),(14,5,NULL,NULL,'2013-11-20 13:37:41','Pending'),(15,5,NULL,NULL,'2013-11-20 13:37:41','Pending'),(16,5,NULL,NULL,'2013-11-20 13:37:41','Pending');
...
insert  into `tbl_history`(`history_id`,`user_id`,`history`,`date_done`) values (1,8,'Assigned peer to employee feedback','2013-11-07 13:27:52'),(2,9,'Evaluate self appraisal','2013-11-07 13:43:13'),(3,2,'Assigned peer to employee feedback','2013-11-07 13:46:39'),(4,2,'Added new training to employee','2013-11-13 06:15:16'),(5,2,'Deleted employee training','2013-11-13 06:15:20'),(6,2,'Assigned peer to employee feedback','2013-11-20 06:36:13'),(7,2,'Assigned peer to employee feedback','2013-11-20 06:45:45'),(8,2,'Evaluate employee appraisal','2013-11-20 14:32:24'),(9,2,'Evaluate employee appraisal','2013-11-20 14:38:19'),(10,2,'Assigned peer to employee feedback','2013-11-21 05:19:37'),(11,6,'Evaluate self appraisal','2013-11-21 05:21:50'),(12,2,'Added new training to employee','2013-11-21 06:30:38'),(13,6,'Evaluate self appraisal','2013-11-21 11:42:27'),(14,2,'Assigned peer to employee feedback','2013-11-26 02:25:16'),(15,6,'Evaluate self appraisal','2013-11-26 02:35:26'),(16,2,'Added new training to employee','2013-11-28 05:18:40');
...
insert  into `tbl_jobs`(`job_id`,`dept_id`,`job_title`,`job_desc`,`date_added`) values (6,1,'Nurse','A person trained to care for the sick or infirm especially in a hospital','0000-00-00 00:00:00'),(7,1,'Test','test','0000-00-00 00:00:00'),(8,1,'asd','asd','0000-00-00 00:00:00');

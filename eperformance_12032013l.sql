...
/*Table structure for table `tbl_appraisal_categories_comment` */

DROP TABLE IF EXISTS `tbl_appraisal_categories_comment`;

CREATE TABLE `tbl_appraisal_categories_comment` (
  `main_category_id` int(11) NOT NULL,
  `appraisal_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `comment` text NOT NULL,
  `date_comment` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `app_type` int(11) NOT NULL COMMENT '0 - self, 1 - peer, 2 - mngr',
  KEY `sub_category_id` (`main_category_id`,`user_id`),
...
/*Table structure for table `tbl_appraisal_potential_questionaire` */

DROP TABLE IF EXISTS `tbl_appraisal_potential_questionaire`;

CREATE TABLE `tbl_appraisal_potential_questionaire` (
  `question_id` int(11) NOT NULL AUTO_INCREMENT,
  `question` text,
  PRIMARY KEY (`question_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1;

/*Table structure for table `tbl_appraisal_potential_result` */

DROP TABLE IF EXISTS `tbl_appraisal_potential_result`;

CREATE TABLE `tbl_appraisal_potential_result` (
  `user_id` int(11) DEFAULT NULL,
